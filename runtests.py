...
if __name__ == "__main__":
    ...
    assert agent0.name == "Agent0"
    assert agent1.name == "Agent1"
    print("*     get_name() => OK")

    agent0.send_message(Message(0, 1, MessagePerformative.COMMIT, "Bonjour"))
    agent1.send_message(Message(1, 0, MessagePerformative.COMMIT, "Bonjour"))
    agent0.send_message(Message(0, 1, MessagePerformative.COMMIT, "Comment ça va ?"))
